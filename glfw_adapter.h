...
namespace mujoco
{
  ...
  public:
    ...
    bool Is1KeyPressed() const override;
    bool Is2KeyPressed() const override;
    bool Is3KeyPressed() const override;
    bool Is4KeyPressed() const override;
    bool Is5KeyPressed() const override;
    bool Is6KeyPressed() const override;
